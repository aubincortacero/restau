...
export const CATEGORY_TYPES = [
  ...
  { id: 'pizza',     label: 'Pizzas',            emoji: '🍕', description: 'Pizzas, flambekuches' },
  { id: 'burger',    label: 'Burgers',           emoji: '🍔', description: 'Burgers, hot-dogs, sandwichs' },
  { id: 'alcohol',   label: 'Alcools & vins',    emoji: '🍷', description: 'Vins, bières, spiritueux' },
