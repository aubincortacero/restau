  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 opacity-50">
      ...
      <button
        type="button"
        disabled
        className="w-full flex items-center gap-4 p-4 rounded-2xl border-2 border-zinc-800 bg-zinc-900/40 cursor-not-allowed text-left"
      >
        <div className="w-11 h-11 rounded-2xl flex items-center justify-center shrink-0 bg-zinc-800">
        ...
        <div className="w-5 h-5 rounded-full border-2 border-zinc-700 flex items-center justify-center shrink-0" />
      </button>
    </div>
  )
}
