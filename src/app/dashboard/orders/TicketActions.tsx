...
export default function TicketActions({ order, inverted }: { order: OrderForTicket; inverted?: boolean }) {
  const [showModal, setShowModal] = useState(false)
  const btnClass = 'flex items-center gap-1.5 text-sm text-zinc-400 hover:text-white border border-zinc-700 hover:border-zinc-500 px-3 py-2 rounded-lg transition-colors cursor-pointer'
